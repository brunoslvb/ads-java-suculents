...
<body>
	...
	<div class="view">
		<div class="banner-home" src="./assets/img/home1.jpg" class="img-fluid" alt="">
			<div class="mask rgba-black-light flex-center justify-content-start pl-5">
				<p class="white-text text-banner fadein-left">Aprenda tudo sobre cactos e suculentas. Harmonie sua casa.
					Ganhe uma renda extra.</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="icons m-4">
			<div class="">
				<img class="" src="./assets/img/planta.png" alt="">
				<p class="font-weight-bold pt-2">Regue.</p>
			</div>
			<div class="">
				<img class="" src="./assets/img/watercan.png" alt="">
				<p class="font-weight-bold pt-2">Cuide.</p>
			</div>
			<div class="">
				<img class="" src="./assets/img/recycle.png" alt="">
				<p class="font-weight-bold pt-2">Propague.</p>
			</div>
		</div>
	</div>
